...
class MapColoringGUI:
    ...
    def stop_and_reset(self, write_log=True):
    ...
    def start_min_conflicts(self):
        ...
        self.current_generator = min_conflicts_search(DISTRICTS, {v: list(COLORS_LIST) for v in DISTRICTS}, NEIGHBORS, NAMES, max_steps=300)
        self.run_animation()
    ...
    def run_animation(self):
        ...
        try:
            step_type, assignment, current_domains, var, val, log_msg = next(self.current_generator)
